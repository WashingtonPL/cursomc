...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("38745678", "38616758"));
	
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Ap 202", "Centro", "56200000", cli1, c1);
		Endereco e2 = new Endereco(null, "Av Matos", "56", "Ap 202", "Batalhão", "56200000", cli1, c2);
